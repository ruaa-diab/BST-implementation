...
public class Tree<T extends Comparable<T>> {
	...
	private int leavesCount(TNode node) {
		...
		return 	leavesCount(node.getLeft())+leavesCount(node.getRight());
	...
	public TNode getPredecessor(TNode node) {
		
		
		TNode parent=node;
		TNode predecessor=node;
		TNode curr=node.getLeft();
